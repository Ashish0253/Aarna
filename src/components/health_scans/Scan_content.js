const Scan_content = [
    {
        ...
        price2: "3000",
        price3: "900",
        description: "Computed tomography or CT/CAT scan is a commonly ordered image diagnostic test that combines X-ray images from several angles and compiles them into a single image using 2D and 3D image reconstruction.The cross-sectional images or ‘slices’ can be taken for any part or structure of the body, including the bones, soft tissues, and blood vessels.",
      },
      {
        id: 1,
      ...
      },
      {
        ...
        price2: "1200",
        price3: "500",
        description: "A digital X-ray test is the most common and non-invasive image diagnostic test that has been around for decades. This image testing is ordered to detect, diagnose, and monitor a host of medical issues. While other imaging tests are typically used to assess hard-to-reach areas (tissues, blood vessels, nerves, etc.), a digital X-ray, on the other hand, gives a quick picture of the bones, chest, teeth, and abdomen.",
      },
      {
        id: 1,
